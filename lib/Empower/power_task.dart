...
class PowerTask extends StatefulWidget {
  PowerTask({Key key}) : super(key: key);

  @override
  _PowerTaskState createState() => _PowerTaskState();
}

class _PowerTaskState extends State<PowerTask> {
  ...
  var Tasks= [
    ...
    "Say Hi to your colleagues whom you have never before!",
